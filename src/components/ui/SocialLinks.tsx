...
export function SocialLinks({ linkedin, github, email, className }: SocialLinksProps) {
  const linkStyles = 'group';
  const iconStyles = 'text-zinc-500 group-hover:text-cyan-500 transition-colors';
